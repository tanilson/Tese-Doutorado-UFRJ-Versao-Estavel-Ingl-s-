...
\hyphenation{ca-mi-nhos}
\hyphenation{fe-de-ral}

\begin{document}
\title{Sobre a Propriedade Helly de Alguns Grafos de Interseção}
  \foreigntitle{
...
\advisor{Prof.}{Claudson Ferreira}{Bornstein}{Ph.D.}
 ...
 \examiner{Profª.}{Márcia Rosana Cerioli, D.Sc.}{D.Sc.}
  ...
  \mainmatter
  \include{capI-introducao}
  \include{capII-GrafosdeInterseccao}
  \include{capIII-propriedadeHellyGrafosEPG}
  \include{capIV-ONumeroDeHelly}
  \include{capV-RelacaoEntreClassesB1-EPGEPTeVPT}
